    ...
    <main>
        <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 230px;">
            <ul class="nav nav-pills flex-column mb-auto">
                <li class="nav-item">
                    <a href="../staff/ManagerHomePage.jsp" class="nav-link active" aria-current="page">
                ...
                <li class="mb-1">                    
                    <button class="btn btn-toggle align-items-center rounded collapsed text-white" data-bs-toggle="collapse" data-bs-target="#home-collapse" aria-expanded="true">
                        Report <svg class="bi me-2" width="16" height="16" style="margin-left:10px;"><use xlink:href="#report"/></svg>
                    </button>
            ...
            <hr>
            Copyright by : <b style="display:inline-block">Alimama</b>


    </main>
    <script src="../styling/bootstrap.bundle.min.js"></script>

    <script src="../styling/sidebars.js"></script>
</body>
</html>
