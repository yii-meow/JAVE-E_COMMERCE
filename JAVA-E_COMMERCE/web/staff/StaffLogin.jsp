    ...
    <body>
        ...
        <div class="form-container">
            ...
            <form action="../staffLogin" method="POST">  
                <div class="form">
                    <input class="input_Field" type="text" name="staffId" id="staffId" placeholder=" " value="${staff.staffID}" required><label class="label_Field">Staff ID</label>
                </div>
                <div class="form">
                    <input class="input_Field" type="password" name="staffPassword" id="password" placeholder=" " required><label class="label_Field">Password</label>
